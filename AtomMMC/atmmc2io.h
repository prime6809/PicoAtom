...
extern uint8_t	InterfaceAddr;
extern uint8_t	InterfaceData;

#define LatchAddressIn()			LatchedAddressLast=InterfaceAddr
#define ReadDataPort()				LatchedData=InterfaceData
#define WriteDataPort(value)		InterfaceData=value
